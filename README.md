...
```toml
[build-system]
requires = ["hatchling>=1.29.0", "pitloom>=0.18.1"]
...
> Suriyawongkul, A. (2026). Pitloom - SBOM generator for AI models and Python projects (Version 0.18.1) [Computer software]. <https://doi.org/10.5281/zenodo.19246283>
