...
:func:`pitloom.extract.remote.huggingface_fetch._fetch_all_hf_data` onto fields of
:class:`~pitloom.core.ai_metadata.AiModelMetadata`, populating *provenance*
in-place as it goes.

See also: :mod:`pitloom.extract.remote.huggingface` (public facade) and
:mod:`pitloom.extract.remote.huggingface_fetch` (Hugging Face Hub I/O and license
resolution).
"""
...
from pitloom.extract.remote.huggingface_fetch import _extract_card_description
