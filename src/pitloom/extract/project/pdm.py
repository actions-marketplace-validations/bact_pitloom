...
:mod:`pitloom.extract.project.setuptools` treats as out of scope for the same
...
construction pattern); :mod:`pitloom.extract.project.pyproject_dynamic` (the caller).
"""
