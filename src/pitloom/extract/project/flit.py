...
how to find -- the same reason :mod:`pitloom.extract.project.poetry` exists
...
+ ``flit_core.common.Module`` lookup); :mod:`pitloom.extract.project.pyproject_dynamic`
...
def resolve_flit_dynamic_metadata(
    ...
    reason :mod:`pitloom.extract.project.setuptools` never executes
