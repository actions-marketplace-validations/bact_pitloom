...
(:mod:`pitloom.extract.lock.pipfile`).

See also: test_pipfile_integration.py for ``read_project()`` lock cascade
integration and real-world fixture coverage;
test_poetry.py/test_pylock.py/test_uv.py for sibling lock extractors;
